...
const Navbar = () => {
    ...
    return (
        <div className="flex justify-between items-center w-full h-12 px-4 text-white bg-gray-700 bg-opacity-30 fixed nav" >
            <div className="navbar-icon">        
                <img src='/images/icons.png'  className="text-white text-3xl mb-2 ml-6 cursor-pointer h-30 w-140 hover:text-gray-500 mt-3 mx-48" />
            </div>
            ...
            <div className="navbar-icon">        
                <img src='/images/G1-core2.png'  className="text-white text-3xl mb-2 ml-3 mr-1 cursor-pointer h-30 w-36 hover:text-gray-500 mt-3" />
            </div>
        </div>
    );
};
